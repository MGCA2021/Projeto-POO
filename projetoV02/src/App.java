	    ...
	    public static void main(String[] args) throws Exception {
	        ...
	        while(systemStatus) {
	            System.out.println(
	                ...
	                + "- Listar os códigos das disciplinas\n3 "
	                + "- Listar informações dos estudantes matriculados\n4 "
	                + "- Listar todas as informações das disciplinas em que um determinado estudante está matriculado\n5 "
	                + "- SAIR"
	            );
